...
public class UserInputParser {
    ...
    public static UserData parse(String input) throws WrongParsingDataException {
        ...
        if (data.length != 6) {
            throw new WrongParsingDataException("Введено неправильное количество данных.");
        }

        String lastName = validateName(data[0], "surname");
        String firstName = validateName(data[1], "name");
        String patronymicName = validateName(data[2], "patronymic");
